...
export function Badge({ children, variant = 'default', className = '', size = 'sm' }) {
  const variants = {
    ...
    warning: 'bg-gold-50 text-gold-700 dark:bg-gold-950/60 dark:text-gold-300 border border-gold-200/50 dark:border-gold-800/50',
    ...
    indigo: 'bg-brand-50 text-brand-700 dark:bg-brand-950/60 dark:text-brand-300 border border-brand-200/50 dark:border-brand-800/50',
